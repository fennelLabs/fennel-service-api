...
urlpatterns = [
    ...
    path("fennel/get_fee_for_remove_trust/", fennel_views.get_fee_for_remove_trust),
    path("fennel/remove_trust/", fennel_views.remove_trust),
    path("fennel/get_fee_for_request_trust/", fennel_views.get_fee_for_request_trust),
    path("fennel/request_trust/", fennel_views.request_trust),
    path(
        "fennel/get_fee_for_cancel_trust_request/",
        fennel_views.get_fee_for_cancel_trust_request,
    ),
    path("fennel/cancel_trust_request/", fennel_views.cancel_trust_request),
    path("fennel/get_trust_requests/", fennel_views.get_trust_requests),
    path("fennel/get_trust_connections/", fennel_views.get_trust_connections),
    path("fennel/check_if_trust_exists/", fennel_views.check_if_trust_exists),
